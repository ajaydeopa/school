...
<div class="row m-b-10 ">
    <div class="col-sm-4">
        <div class="input-group">
            <span class="input-group-addon"><i class="zmdi zmdi-local-mall zmdi-hc-fw"></i></span>
            <div class="fg-line">
                <input type="date" class="form-control" placeholder="Joining date" name="joining_date">
            </div>
...
<div class="input-group m-b-10 ">
    ...
    <div class="fg-line">
        <textarea class="form-control auto-size" placeholder="Residential Address" name="residential_addr" rows="3" data-autosize-on="true" style="overflow: hidden; word-wrap: break-word"></textarea>
    </div>
...
<div class="input-group m-b-10 ">
    <span class="input-group-addon"><i class="zmdi zmdi-assignment zmdi-hc-fw"></i></span>
    <div class="fg-line">
        <textarea class="form-control auto-size" placeholder="Permanent Address" name="permanent_addr" rows="3" data-autosize-on="true" style="overflow: hidden; word-wrap: break-word"></textarea>
    </div>
